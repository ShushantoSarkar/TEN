    ...
    <>
      <div className="hiring">
        ...
        <p>
          ...
          learning program for students currently enrolled in India. There is a
          small registration fee, INR 400 /- (RUPEES Four HUNDRED ONLY)
          applicable to all incoming interns as part of this One-of-a-Kind Point
          based Program. This is required not just to ensure a seamless
        ...
        <div className="flex">
          <p>
            ...
            keep the payment transaction ID handy for submitting the form. Note:
            This internship does not offer an opportunity to earn money, rather
            helps an individual grow by working on the job and earn a
            certificate upon successful completion. Check out few of our open
            internship positions below Refer the application form for more open
            positions Digital Marketing Interns General Management Interns
            Technical/Software Experts Product Management Interns Content
            Interns and more...
          </p>
      ...
      <div className="applicationForm">
        ...
        <form action="#">
          ...
          <select>
            ...
            <option value="Text Content Presentation">
